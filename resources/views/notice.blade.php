        ...
        <div class="input-group">
            <div class="form-outline" data-mdb-input-init>
                <form action="{{ route('notice') }}" method="get">
                    <input type="text" class="form-control-sm" name="search" placeholder="{{ $search ?? '검색' }}"
                        id="search">
            </div>
            ...
            <div class="btn-group" style="margin-left: 15px">
                <button class="btn btn-secondary btn-sm dropdown-toggle" id="dropdownMenuButton" type="button"
            ...
            <tbody>
                @foreach ($notice as $notices)
                    <tr>
                        ...
                        <td>관리자</td>
                        <td>
                            <a href="{{ route('notice.getbyid', $notices->id) }}">{{ $notices->subject }}</a>
                        </td>
